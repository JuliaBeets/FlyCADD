...
:Modification: Julia Beets, 10-7-2023
...
if options.chromosomes != '':
  filenames = [options.params_folder + "D_MELANOGASTER_" + options.params_folder.replace("/", '').replace("log", "", 1) + "_chr" + x + ".log" for x in options.chromosomes.split(',')]
else:
