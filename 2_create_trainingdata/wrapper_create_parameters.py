...
for chr_number in chr_list:
	os.system('python create_parameters.py -a ' + options.an_p + options.prefix + 'chr' + chr_number + '.fa' + ' -r ' + options.r_p + options.reference + chr_number + '.fa' + ' -c ' + chr_number + ' -o ' + options.species + '_chr' + chr_number + '.log')
